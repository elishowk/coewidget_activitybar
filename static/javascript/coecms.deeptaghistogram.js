/**
*  DeepTagHistogram implements videotag cloud visualization
*  depends on :
*  * d3.js and d3.layout
...
$.uce.DeepTagHistogram = function(){};
$.uce.DeepTagHistogram.prototype = {
    options: {
        ucemeeting: null,
        uceclient: null,
        player: null,
    ...
    */
    ...
    setSize: function(width, height) {
        this.options.baseHeight = height;
        this.options.baseWidth = width;
        this.element.find(".svg-container").attr("width", width);
        this.element.find(".svg-container").attr("height", height);
...
$.uce.widget("deeptaghistogram", new $.uce.DeepTagHistogram());
